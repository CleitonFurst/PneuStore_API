...
namespace PneuStore_API.Migrations
{
    ...
    [Migration("20211003130545_alteracaoModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PneuStore_API.Model.Pedido", b =>
                {
                    b.HasOne("PneuStore_API.Model.Produto", "Produto")
                        .WithMany("Pedidos")
                        .HasForeignKey("ProdutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PneuStore_API.Model.Usuario", "Usuario")
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("PneuStore_API.Model.Produto", b =>
                {
                    b.HasOne("PneuStore_API.Model.Cart", "Cart")
                        .WithMany()
